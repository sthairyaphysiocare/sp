    ...
    return (
      <div className="text-center py-20">
        ...
        <p className="text-muted-foreground mt-2">
          Your role does not permit creating new patients.
        </p>
        <Link to="/app/patients" className="mt-4 inline-block text-brand hover:underline">
          ← Back to patients
        </Link>
      </div>
    );
  ...
  return (
    <div>
      ...
      <p className="text-sm text-muted-foreground mt-1">
        Auto-assigned ID: <span className="font-mono text-brand">{nextPid}</span>
      </p>
      ...
      <form onSubmit={submit} className="mt-6 space-y-6">
        <section className="p-6 rounded-2xl bg-card border space-y-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              <Input value={f.n} onChange={(e) => setF({ ...f, n: e.target.value })} required />
            </div>
            <div>
            ...
            <div>
              <Label>Mobile *</Label>
              <Input value={f.m} onChange={(e) => setF({ ...f, m: e.target.value })} required />
            </div>
            <div>
            ...
            <div>
              <Label>Email</Label>
              <Input type="email" value={f.e} onChange={(e) => setF({ ...f, e: e.target.value })} />
            </div>
            <div>
        ...
        {hasRole("admin", "therapist", "reception") && (
          <section className="p-6 rounded-2xl bg-card border space-y-4">
        ...
        <div className="flex gap-3">
          <Button type="submit" size="lg" className="brand-gradient text-white border-0">
            Create Patient
          </Button>
