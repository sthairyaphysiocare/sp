    ...
    <PublicLayout>
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
        ...
        <div className="mt-10 space-y-6 text-foreground/90 leading-relaxed">
          <p>
            Our clinic in Puttur serves patients across age groups — from athletes recovering
            from sports injuries to seniors regaining mobility after joint replacement.
            We specialise in musculoskeletal disorders, sports medicine, neurological
            rehabilitation, and post-operative recovery.
          </p>
          <p>
            Every patient receives a structured assessment, personalised treatment plan,
            and measurable progress tracking. Our therapists use manual therapy, electrotherapy
