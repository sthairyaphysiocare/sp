      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
        ...
        <div className="mt-10 space-y-6 text-foreground/90 leading-relaxed">
          ...
          <p>
            ...
            modalities, taping techniques, and targeted exercise prescriptions to restore function
            and reduce pain.
          </p>
          <p>
            We believe physiotherapy should empower you not just to recover, but to live stronger,
            move freer and prevent future injury.
          </p>
        </div>
        ...
        <div className="mt-12 grid sm:grid-cols-3 gap-5">
          {[
            ...
            {
              t: "Vision",
              d: "Be the most trusted physiotherapy partner.",
              bg: "#1188b32e",
              border: "#1188b361",
              fg: "#1188B3",
            },
            ...
            >
              <h3 className="font-semibold" style={{ color: x.fg }}>
                {x.t}
              </h3>
